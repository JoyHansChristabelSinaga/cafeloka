...
<html lang="en">
    ...
    <head>
        ...
        <!-- ======================================================= * Template Name:
        iPortfolio - v3.9.1 * Template URL:
    ...
    <body>
        ...
        <header id="header">
            <div class="d-flex flex-column">
                ...
                <div class="profile">
                    <img
                        src="template/assets/img/profile-img.jpg"
                        alt=""
        ...
        <section
            ...
            <div class="hero-container" data-aos="fade-in">
                <h1>CAFELOKA</h1>
                <p>Dapat
                    <span class="typed" data-typed-items="Membantu anda menemukan berbagai Cafe"></span></p>
            </div>
        </section>
        <!-- End Hero -->
                    ...
                    <div class="row text-center g-4">
                        <div class="col-md">
                            <div class="d-flex mr-3">
                                <div class="card bg-dark text-light me-3 col-3 m-">
        ...
        <script src="template/assets/vendor/typed.js/typed.min.js"></script>
