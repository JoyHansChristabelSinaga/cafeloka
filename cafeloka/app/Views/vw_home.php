                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start ">
                                    <div class="stats-icon purple blue mb-2">
                                        <i class="iconly-boldShow"></i>
                                    </div>
                                </div>
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <h6 class="text-muted font-semibold">Views</h6>
                                    <h6 class="font-extrabold mb-0">111k</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <h6 class="font-extrabold mb-0">25k</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <h6 class="font-extrabold mb-0">100k</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="d-flex mr-3">
                                                <div class="card bg-dark text-light me-3" style="width:30vw ;">
                                                    <div class="card-body text-center mb-3">
                                                        ...
                                                        <p class="card-text" style="color:black ;"><?= $value->alamat ?></p>
            ...
            <div class="card">
                <div class="card-body py-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3 name">
                            <h5 class="font-bold">Joy Bro</h5>
                            <h6 class="text-muted mb-0">@joyBro23</h6>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-content pb-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        ...
                        <div class="name ms-4">
                            <h5 class="mb-1">Riyo aj</h5>
                            <h6 class="text-muted mb-0">@Riyoilkomp12</h6>
                        </div>
                    </div>
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                        ...
                        <div class="name ms-4">
                            ...
                            <h6 class="text-muted mb-0">@Fakhriilkomp20</h6>
                        </div>
                    </div>
                    <div class="px-4">
