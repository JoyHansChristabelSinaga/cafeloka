              ...
              <div class="row">
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="<?= $jumlahBooking ?>" data-purecounter-duration="2" class="purecounter"></span>
                    <p><strong>Jumlah Booking</strong></p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="<?= $jumlahDaerah ?>" data-purecounter-duration="4" class="purecounter"></span>
                    <p><strong>Jumlah Cabang</strong></p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="<?= $jumlahUser ?>" data-purecounter-duration="4" class="purecounter"></span>
                    <p><strong>Jumlah User</strong></p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
